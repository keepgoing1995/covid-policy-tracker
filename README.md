...
-->
- We have published our V4 indicator recording mandatory [_vaccination_ policies](documentation/codebook.md#vaccination-policies) and an experimental csv publishing [differentiated_vaccination_policies](https://github.com/OxCGRT/covid-policy-scratchpad).
